...
public class CharacterSelectScreenPatches
{
    ...
    public static final String[] TEXT = CardCrawlGame.languagePack.getEventString("AmiyaMod:selchar").OPTIONS;
    public static int TalentCount = Amiya.Skin;
    ...
    public static class CharacterSelectScreenPatch_Render
    {
        ...
        public static void Postfix(CharacterSelectScreen __instance, SpriteBatch sb)
        {
            ...
            for (CharacterOption o : __instance.options) {
                ...
                if (o.name.equals(title) && o.selected) {
 ...
 */
    ...
    public static Texture updateBgImg(){
        return new Texture("img/character/Amiya/AmiyaBG"+TalentCount+".png");
    }
}