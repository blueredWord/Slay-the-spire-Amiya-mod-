...
public class BigNotWork extends CustomCard {
    private static final String NAME = "BigNotWork";//卡片名字
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new BigNotWorkPower(this.magicNumber)));
    }

    public AbstractCard makeCopy() { return new BigNotWork(); }
}
