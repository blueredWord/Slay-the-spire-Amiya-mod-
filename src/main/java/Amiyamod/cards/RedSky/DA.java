...
public class DA extends CustomCard {
    //=================================================================================================================
    //@ 【待调弦的怒火】 出鞘 : 获得 [E] 。 NL 消耗 。
    //=================================================================================================================
    private static final String NAME = "DA";// 【卡片名字】
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        Amiyamod.Sword(true,new GainEnergyAction(this.misc));
    }

    public AbstractCard makeCopy() {return new DA();}
}
