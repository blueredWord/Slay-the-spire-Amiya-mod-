...
public class Bonk extends CustomCard {
    //=================================================================================================================
    //@  【鞘击】 造成 !D! 点伤害，给予 !M!层 虚弱 。 入鞘 :获得 [E] 。
    //=================================================================================================================
    private static final String NAME = "Bonk";// 【卡片名字】
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new BonkPower(this.misc)));
        Amiyamod.Sword(true,new BonkAction(this.magicNumber));
    }

    public AbstractCard makeCopy() {return new Bonk();}
}
