...
public class ShadowBlueFire extends CustomCard {
    private static final String NAME = "ShadowBlueFire";//卡片名字
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new ShadowBlueFirePower()));
    }
    public AbstractCard makeCopy() {return new ShadowBlueFire();}
}
