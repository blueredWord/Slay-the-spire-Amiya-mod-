...
//星火重燃
//每回合获得的第1张不是卡组中的卡牌会额外获得1张复制。
public class FireAgain extends CustomCard {
    private static final String NAME = "FireAgain";//卡片名字
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new FireAgainPower(this.magicNumber)));
    }

    public AbstractCard makeCopy() { return new FireAgain(); }
}
