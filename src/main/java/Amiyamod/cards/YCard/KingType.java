...
public class KingType extends CustomCard {
    private static final String NAME = "KingType";//卡片名字
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p,p,new KingTypePower(-1)));
    }

    public AbstractCard makeCopy() {return new KingType();}
}
