...
import Amiyamod.action.cards.KKZAction;
...
public class KKZ extends CustomCard {
    //=================================================================================================================
    //@ 【提卡兹巫咒】  急性发作 。 源石技艺 。 NL 造成 !D! 点伤害2次，抽2张牌。 NL 抽到 源石诅咒 或 源石技艺 时，获得 [E] 。
    //=================================================================================================================
    private static final String NAME = "KKZ";// 【卡片名字】

    public static final String ID = Amiyamod.makeID(NAME);//卡片ID
    private static final CardColor COLOR = CardColorEnum.AMIYA;//卡牌颜色
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String IMG_PATH = "img/cards/OldDoki.png";//卡图
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        //抽卡
        if(this.upgraded){this.addToBot(new ScryAction(this.magicNumber));}
        this.addToBot(new DrawCardAction(this.draw,new KKZAction()));

        //}else {
        // this.addToBot(new DrawCardAction(this.magicNumber));}
        //,new TikaziMagicAction()
    }
    public AbstractCard makeCopy() {return new KKZ();}
}
