...
public class XingTaSuoXing extends CustomCard {
    private static final String NAME = "XingTaSuoXing";//卡片名字
    ...
    public AbstractCard makeCopy() {return new XingTaSuoXing();}
}
