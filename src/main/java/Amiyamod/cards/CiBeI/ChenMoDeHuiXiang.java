...
//  沉默的回响
//  对所有敌人造成X（X+1）次4点伤害，获得X（X+1）次4点丝线。燃己Xs
public class ChenMoDeHuiXiang extends CustomCard {
    private static final String NAME = "ChenMoDeHuiXiang";//卡片名字
