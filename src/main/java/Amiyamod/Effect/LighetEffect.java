...
public class LighetEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public LighetEffect(int x) {
        if (this.img == null) {
            this.img = ImageMaster.CRYSTAL_IMPACT;
        }
        this.x = AbstractDungeon.player.hb_x - (float)this.img.packedWidth / 2.0F;
        this.y = AbstractDungeon.player.hb_y - (float)this.img.packedHeight / 2.0F;
    ...
    public LighetEffect(int x,boolean zzz) {
        if (this.img == null) {
            this.img = ImageMaster.CRYSTAL_IMPACT;
        }
        Color c = Color.BLACK;
