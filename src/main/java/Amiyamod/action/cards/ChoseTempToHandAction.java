...
public class ChoseTempToHandAction extends AbstractGameAction {
    ...
    public ChoseTempToHandAction(AbstractCard card, boolean isOtherCardInCenter) {
    ...
    public ChoseTempToHandAction(AbstractCard card) {
        this(card, 1);
    }

    public ChoseTempToHandAction(AbstractCard card, int amount) {
        this.isOtherCardInCenter = true;
        this.sameUUID = false;
        UnlockTracker.markCardAsSeen(card.cardID);
        this.amount = amount;
    ...
    public ChoseTempToHandAction(AbstractCard card, int amount, boolean isOtherCardInCenter) {
        this(card, amount);
        this.isOtherCardInCenter = isOtherCardInCenter;
    }

    public ChoseTempToHandAction(AbstractCard card, boolean isOtherCardInCenter, boolean sameUUID) {
        this(card, 1);
        this.isOtherCardInCenter = isOtherCardInCenter;
