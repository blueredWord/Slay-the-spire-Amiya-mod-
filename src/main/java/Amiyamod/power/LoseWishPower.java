...
public class LoseWishPower extends AbstractPower {
    public static final String NAME = "LoseWishPower";
    public static final String ID1 = Amiyamod.makeID(NAME);
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(ID1);
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public LoseWishPower(int i) {
