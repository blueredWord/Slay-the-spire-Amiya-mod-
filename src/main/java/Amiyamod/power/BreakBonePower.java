...
import Amiyamod.cards.Memory.BreakBone;
...
public class BreakBonePower extends AbstractPower implements OnLoseTempHpPower {
    public static final String NAME = "BreakBonePower";
    public static final String POWER_ID = Amiyamod.makeID(NAME);
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public BreakBonePower(int amount) {
    ...
    public int onLoseTempHp(DamageInfo info, int damageAmount){
        ...
        if ( damageAmount > 0 && damageAmount >= tem){
            ...
            this.addToBot(new MakeTempCardInHandAction(new BreakBone(),this.amount));
