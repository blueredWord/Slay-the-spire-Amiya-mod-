...
public class HornPower extends AbstractPower implements OnLoseTempHpPower {
    public static final String NAME = "HornPower";
    public static final String POWER_ID = Amiyamod.makeID(NAME);
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    public HornPower(AbstractCreature owner, int amount) {
    ...
    public int onLoseHp(int damageAmount) {
        if (damageAmount>0){
            ...
            this.addToBot(new ApplyPowerAction(this.owner, this.owner, new LoseStrengthPower(this.owner, amount)));
        }
        return damageAmount;
    }
}
